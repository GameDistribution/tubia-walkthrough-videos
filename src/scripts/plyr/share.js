...
class Share {
    ...
    setup() {
        ...
        document.querySelector('.plyr--share-button').addEventListener('click', () => Share.openShareScreen.call(this));
    }
    ...
    static openShareScreen() {
        ...
        if(!json) {
            ...
            const { gameHref, videoTitle } = JSON.parse(json);
            shareLink = gameHref;
            shareText = videoTitle;
        }
        ...
        <div>
            ...
            <div class="plyr--share-buttons-wrapper">
                <a class="plyr--sharing-button__link" href="https://facebook.com/sharer/sharer.php?u=${shareLink}&quote=Hey! Let's play ${shareText} game on ${shareLink}!" target="_blank" rel="noopener" aria-label="">
                ...
                <a class="plyr--sharing-button__link" href="https://twitter.com/intent/tweet/?text=Hey! Let's play ${shareText} game on ${shareLink}!" target="_blank" rel="noopener" aria-label="">
                ...
                <a class="plyr--sharing-button__link" href="whatsapp://send?text=Hey! Let's play ${shareText} game on ${shareLink}!" target="_blank" rel="noopener" aria-label="">
