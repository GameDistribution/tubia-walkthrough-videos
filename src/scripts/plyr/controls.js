...
const controls = {
    ...
    createNewVideoInfo() {
        const classes = this.player.config.classNames.videoinfo;
        
        const newVideoInfoContainer = utils.createElement('div', {
            class: 'new-video-info-container hide',
            id: classes.container,
        });
        const newVideoInfo = utils.createElement('div', {
            class: 'new-video-info',
            id: classes.info,
        });
        const newVideoIcon = utils.createElement('div', {
            class: 'new-video-icon',
            id: classes.icon,
        });
        newVideoInfo.insertAdjacentHTML('afterbegin', '<span>Don\'t miss this out!</span>');
        
        newVideoIcon.insertAdjacentHTML('beforeend', `<?xml version="1.0" encoding="utf-8"?>
        ...
        utils.appendChildren(newVideoInfoContainer, [
            newVideoInfo,
            newVideoIcon,
        ]);

        return newVideoInfoContainer;
    },
